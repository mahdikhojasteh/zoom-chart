...
export default {
  ...
  computed: {
    ...mapState("storeDashboard", ["stateBarImage"])
  },
  ...
  watch: {
    ...
    showImg(val) {
      if (!val) {
        this.saveImage = this.stateBarImage;
        this.actUpdateBarImage("");
      } else if (this.saveImage) {
        this.actUpdateBarImage(this.saveImage);
        this.saveImage = "";
      } else {
        this.actUpdateBarImage(val);
      }
    },
    image(val) {
      this.actUpdateBarImage(val);
  ...
  methods: {
    ...mapActions("storeDashboard", ["actUpdateBarImage"])
  }
};
</script>
